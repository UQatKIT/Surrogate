...
surrogate_model_settings = surrogate_model.SKLearnGPSettings(
    ...
    correlation_kernel=RBF(length_scale=4 * (1.0,), length_scale_bounds=4 * ((1e-5, 1e5),)),
    data_noise=1e-6,
    ...
    init_seed=0,
    checkpoint_load_file=Path("ridgecrest_4D_preT110/surrogate_checkpoint_Bpretraining.pkl"),
...
visualization_settings = visualization.VisualizationSettings(
    offline_checkpoint_file=Path("ridgecrest_4D_preT110/surrogate_checkpoint_Bpretraining.pkl"),
    # online_checkpoint_filestub=Path("ridgecrest_main2D_T0/surrogate_checkpoint"),
    online_checkpoint_filestub=None,
    visualization_file=Path("ridgecrest_4D_preT110/visualization.pdf"),
