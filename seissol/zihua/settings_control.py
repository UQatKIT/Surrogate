...
surrogate_model_settings = surrogate_model.SKLearnGPSettings(
    ...
    init_seed=0,
    checkpoint_load_file="results_T14_seissol_zihua/surrogate_checkpoint_0.pkl",
    checkpoint_save_path=Path("results_T22_seissol_zihua"),
)
...
control_logger_settings = utils.LoggerSettings(
    do_printing=True,
    logfile_path=Path("results_T22_seissol_zihua/online.log"),
    write_mode="w",
)
