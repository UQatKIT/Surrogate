...
class pretraining_settings:
    offline_checkpoint_path = Path("results_seissol_zihua/surrogate_checkpoint_pretraining.pkl")
    offline_visualization_file = Path("results_seissol_zihua/pretraining.pdf")
...
class online_settings:
    ...
    checkpoint_path = Path("results_seissol_zihua")
    offline_checkpoint_path = Path("results_seissol_zihua/surrogate_checkpoint_pretraining.pkl")
    online_visualization_file = Path("results_seissol_zihua/online.pdf")
