...
surrogate_model_settings = surrogate_model.SKLearnGPSettings(
    ...
    correlation_kernel=RBF(length_scale=1e6, length_scale_bounds=(1e6, 1e10)),
    data_noise=1e-6,
    ...
    variance_underflow_threshold=1e-6,
...
logger_settings = surrogate_control.LoggerSettings(
    do_printing=True,
    logfile_path=Path("surrogate.log"),
    write_mode="w"
)
